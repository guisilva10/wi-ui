...
export default function NextjsPage() {
  return (
    <DocPage
      title="Next.js"
      description="Como instalar e configurar WI.UI em um projeto Next.js com App Router e Tailwind v4."
    ...
    >
      <DocSection id="pre-requisitos" title="Pre-requisitos">
        <ul className="text-muted-foreground list-inside list-disc space-y-1.5 text-sm">
          <li>Next.js 14+ (App Router recomendado)</li>
        ...
        <CommandBlock
          commands={{
            pnpm: "pnpm create next-app@latest meu-projeto --ts --tailwind --app",
            npm: "npx create-next-app@latest meu-projeto --ts --tailwind --app",
            yarn: "yarn create next-app meu-projeto --ts --tailwind --app",
            bun: "bunx create-next-app@latest meu-projeto --ts --tailwind --app",
          }}
        />
      </DocSection>
      ...
      <DocSection id="via-cli" title="Via CLI (recomendado)">
        <p className="text-muted-foreground mb-3 text-sm">
          O jeito mais rapido. O CLI detecta Next.js automaticamente e configura
          tudo: cria{" "}
  ...
  "compilerOptions": {
    ...
    "paths": {
      ...
      <DocSection id="configuracao" title="Configuracao">
        <p className="text-muted-foreground mb-3 text-sm">
          O CLI cria o arquivo{" "}
          <code className="bg-muted rounded-md px-1.5 py-0.5 font-mono text-xs">
            wi-ui.json
          </code>{" "}
          na raiz do projeto. Se instalou manualmente, crie assim:
        </p>
...
.dark {
  ...
  --color-border: oklch(0.269 0 0);
      ...
      <DocSection id="adicionar-componente" title="Adicionar componente">
        <p className="text-muted-foreground mb-3 text-sm">Com CLI:</p>
        ...
        <p className="text-muted-foreground mt-3 text-sm">
          Sem CLI: copie o codigo do componente da documentacao para{" "}
          <code className="bg-muted rounded-md px-1.5 py-0.5 font-mono text-xs">
            src/components/ui/
          </code>
          . Cada componente mostra o codigo-fonte completo na sua pagina de
          docs.
        </p>
      </DocSection>
